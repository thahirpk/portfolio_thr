      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            I fell in love with Linux and Cloud Technologies, DevOps I have at least learnt something, I think… 🤷‍♂️
              <br />
              <br />I am fluent in classics like
              <i>
                <b className="purple"> Linux, AWS and Azure, Docker, Jenkins, Kubernetes. </b>
              </i>
              <br />
              <br />
